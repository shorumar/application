...
class Config {
  ...
  /// Generated by SiteNative 10-11-2023 06:14:37
  /// App UID: c69b4386-f034-e9f9-4ec7-2594ffc9be36
  /// Version: https://my.horumar.net/backend/
  /// API server: {VERSION}

  /// *** App config *** ///
  // App name
  static String appName = "Piksby";
  // App link
  static String appLink = "https://piksby.com/";
  ...
  // Admin email
  static String appEmail = "Qoraa@qoraa.net";
  // Template
  ...
  // Signing
  static String osSigning = "ab70a289d93eaa0ffae05b7cc56e52244dd7aaaf9234ec74c9fbd971df9297bd";
  // Enabled android?
  ...
  static List<NavigationItem> mainNavigation = [
    	NavigationItem(name: "google",icon: "albums-outline.svg",type: ActionType.internal,value: "https://piksby.com/",),
	NavigationItem(name: "piksera",icon: "albums-outline.svg",type: ActionType.external,value: "https://piksera.com/",),
	NavigationItem(name: "share",icon: "albums-outline.svg",type: ActionType.share,value: "",),
	NavigationItem(name: "exit",icon: "add-outline.svg",type: ActionType.share,value: "",),
